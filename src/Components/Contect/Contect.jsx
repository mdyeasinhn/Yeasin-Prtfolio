...
const Contect = () => {
    const socialLinks = [
        {
            href: 'https://www.github.com/mdyeasinhn',
        ...
        {
            href: 'https://www.linkedin.com/in/mdyeasinhn',
            icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {
            href: 'https://www.instagram.com/mdyeasinhn',
    ...
    return (
        <section id='contact' className="">
            ...
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch ">
              ...
              <h2 className="text-3xl lg:text-4xl lg:leading-tight font-semibold  max-w-[12ch]">Contact me for collaboration</h2>
                <p className='text-zinc-400 mt-3 mb-8  max-w-[50ch] lg:mx-w-[30ch]'>Reach out today to discuss your project needs and start collaborating on something amazing!</p>
